...
- source_spec: `_bmad-output/implementation-artifacts/spec-epic-6-retro-item-38-a-queued-claim-keeps-the-meaning-it-had.md`
  summary: "`due_time_as_of()` answers with the commitment's creation time for any day after its time was cleared, so a day that was genuinely untimed can read as timed."
