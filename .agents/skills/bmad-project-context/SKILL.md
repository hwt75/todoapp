...
Where an instruction elsewhere contradicts the block in a way that changes behavior — a stale `AGENTS.md` line, a retired command — propose the fix to that file. Two live contradictory instructions is a defect.
